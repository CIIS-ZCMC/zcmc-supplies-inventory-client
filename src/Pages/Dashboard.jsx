...
function Dashboard() {
  ...
  const {
    items_for_disposal,
    most_consumed_items,
    not_consumed_without_ris,
    reorder_items,
    sufficient_but_not_consumed,
    zero_stocks,
    total_records,
  } = dashboardTotal || {};
      ...
      <Stack gap={2} mt={2}>
          ...
          <Box display="flex" direction="row" justifyContent="space-between">
            ...
            >
              ...
              <Typography fontSize={12}>
                Values displayed are based on monthly averages excluding zero
                stocks and unused items.
              </Typography>
            </Stack>

            <Stack direction={"row"} spacing={1} alignItems={"center"}>
              <Typography fontSize={14}>Legends:</Typography>
        ...
        <ContainerComponent>
          <PaginatedTable
            ...
            tableDesc={
              "See how resource supplies were accumulated and consumed in your organization’s inventory."
            }
